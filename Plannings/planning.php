        ...
        for($i = 0; $i < $weeks; $i++): ?>
            ...
            <tr>
                ...
                <?php if($i === 0): ?>
                    ...
                    <?php $effectif = $ReservationManager->effectifTotalConfirmed($date->format('Y-m-d')); ?>
            ...
            $reservationsWeeks = $ReservationManager->getListeReservationsConfirmedByWeeks($date->format('Y-m-d'), $date->modify('+ 6 days')->format('Y-m-d'));
                    ...
                    <?php foreach($month->days as $k => $day):
                        ...
                        if(!$month->withinMonth($date)) :
                            if($reservation->getDateDebut() <= $date->format('Y-m-d') && $date->format('Y-m-d') < $reservation->getDateFin()): ?>
                                ...
                                <td>
                                    <div class="calendar__reservation__weeks confirmed <?= $month->withinMonth($date) ? '' : 'opacity' ; ?> <?= $_COOKIE['compress']; ?>">
                        ...
                        <?php elseif($reservation->getDateFin() == $date->format('Y-m-d')): ?>
                            ...
                            <td>
                                <div class="calendar__reservation__weeks confirmed depart <?= $month->withinMonth($date) ? '' : 'opacity' ; ?> <?= $_COOKIE['compress']; ?>">
                                    <span><?= $count . "/" . $duration; ?></span>
